...
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div></div></div><h3 id="a-more-complex-example" tabindex="-1">A more complex example <a class="header-anchor" href="#a-more-complex-example" aria-label="Permalink to &quot;A more complex example&quot;">​</a></h3><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-P3uyU" id="tab-twhKGoi" checked="checked"><label for="tab-twhKGoi">example.ts</label><input type="radio" name="group-P3uyU" id="tab-FYP5iBl"><label for="tab-FYP5iBl">abi.ts</label><input type="radio" name="group-P3uyU" id="tab-H_6MOc3"><label for="tab-H_6MOc3">client.ts</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { decodeFunctionResult } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;viem&#39;</span></span>
<span class="line"></span>
